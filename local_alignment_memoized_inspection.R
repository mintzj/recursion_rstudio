...
# do iiiiit
x <- char_vec("TATCTGCAACGATGACGA")
y <- char_vec("CGTGCACGATAG")
...
###########################
## find the largest scoring subproblems
## in the cache
print(tail(cache_df[order(cache_df$score),]))
